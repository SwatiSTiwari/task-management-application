...
import IconSummary from "@/public/icons/IconSummary";
...
function MiniSidebar() {
  ...
  const navItems = [
    ...
    {
      icon: <IconUser strokeColor={getStrokeColor("/taskfolder")} />,
      title: "table",
      link: "/taskfolder",
    },
    {
      icon: <IconSummary strokeColor={getStrokeColor("/tasktable")} />,
      title: "summery",
      link: "/tasktable",
    },
  ];
