  ...
  return (
    <div className="fixed left-0 top-0 z-50 h-full w-full bg-[#333]/30 overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="completed">Assign User</label>
          <div className="flex items-center justify-between bg-[#F9F9F9] p-2 rounded-md border">
            <label htmlFor="completed">select user</label>
            <div>
              <select
                className="bg-[#F9F9F9] p-2 rounded-md border cursor-pointer"
                name="completed"
                ...
                onChange={(e) => handleInput("completed")(e)}
              >
                <option value="false">User1</option>
                <option value="true">User2</option>
                <option value="false">User3</option>
                <option value="true">User4</option>
              </select>
            </div>
          </div>
        </div>
